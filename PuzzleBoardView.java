...
public class PuzzleBoardView extends View {
    ...
    public void shuffle() {
        //When we haven't started solving
    ...
    public void solve() {
        PriorityQueue<PuzzleBoard> lqueue = new PriorityQueue<>(1,mPuzzleBoardComparator);
        ...
        {
            PuzzleBoard bestState = lqueue.poll();
            if(!bestState.resolved())
            {
                lqueue.addAll(bestState.neighbours());
            }
            else
            {
    ...
    Comparator<PuzzleBoard> mPuzzleBoardComparator = new Comparator<PuzzleBoard>() {
        @Override
        public int compare(PuzzleBoard pPuzzleBoard, PuzzleBoard pT1) {
            return pPuzzleBoard.priority()-pT1.priority();
        }
    };
}
